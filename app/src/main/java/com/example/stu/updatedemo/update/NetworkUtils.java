...
public final class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) App.getmContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) App.getmContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) App.getmContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) App.getmContext()
    ...
    public static boolean Available() {
        ConnectivityManager connectivity = (ConnectivityManager) App.getmContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
